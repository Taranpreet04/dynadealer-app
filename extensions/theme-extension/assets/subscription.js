...
//             item.parentNode.insertAdjacentElement('afterend', cusDiv);
...
//                    <span class="var-entries desktop-entries">${getEntries(item?.description)} Entries</span>
//                   <div class="selected-widget-Plan">
//                           <div id="right-side-widget">
//                             <ul id="widget-list">
//                                 <li>Get ${getEntries(item?.description)} entries into every monthly ${productJson.type} draw.</li>
//                                 <li id="description">Cancel anytime.</li>
//                             </ul>
//                           </div>
//                         </div>
//                 </div>
